...
sjcl.bitArray = {
  ...
  concat: function (a, b) {
    ...
    return 32 === d
      ? a.concat(b)
      : sjcl.bitArray.R(b, d, c | 0, a.slice(0, a.length - 1));
  },
...
sjcl.codec.base32 = {
  ...
  fromBits: function (a, b, c) {
    ...
    for (c = 0; g.length * d < l; )
      (g += h.charAt((k ^ (a[c] >>> f)) >>> e)),
        f < d ? ((k = a[c] << (d - f)), (f += e), c++) : ((k <<= d), (f -= d));
    for (; g.length & 7 && !b; ) g += "=";
    return g;
  },
  toBits: function (a, b) {
...
sjcl.hash.sha256 = function (a) {
  this.b[0] || this.G();
  a
    ? ((this.s = a.s.slice(0)), (this.o = a.o.slice(0)), (this.i = a.i))
    : this.reset();
};
...
sjcl.mode.ccm = {
  ...
  ea: function (a, b, c, d, e, g) {
    ...
    if (b.length) {
      ...
      65279 >= c
        ? (f = [h.partial(16, c)])
        : 4294967295 >= c && (f = h.concat([h.partial(16, 65534)], [c]));
      f = h.concat(f, b);
...
sjcl.prng.prototype = {
  ...
  isReady: function (a) {
    ...
    return this.k && this.k >= a
      ? this.j[0] > this.T && new Date().valueOf() > this.Q
        ? this.A | this.w
        : this.w
      : this.e >= a
      ? this.A | this.m
