      ...
      function (a, b, c, d, w, p, A, s, H, N, J) {
        ...
        function S(a, b, c, d, e, f) {
          ...
          for (var h = [], l, k, r, n, p, u = 0; u < a.length; u++) {
            ...
            l =
              (f && f.terminal) || !(r = a[u].childNodes) || !r.length
                ? null
                : S(
                    r,
                    f
        ...
        function E(a, b, d, e, f, g, h, k, r) {
          ...
          function K(a, c, e, f, g, l) {
            ...
            P &&
              ...
              (B.$$isolateBindings = P.$$isolateBindings),
              Y(c, f, B, B.$$isolateBindings, P, B));
            if (A) {
              var m = P || S,
                H;
              m &&
          ...
          for (
            ...
            !E.templateUrl &&
              ...
              ((v = E.controller),
              (w = w || ga()),
              O("'" + x + "' controller", w[x], E, ba),
              (w[x] = E));
            if ((v = E.transclude))
              (m = !0),
                E.$$tlb || (O("transclusion", A, E, ba), (A = E)),
                "element" == v
                  ? ((s = !0),
                    (J = E.priority),
                    (v = ba),
            ...
            if (E.template)
              if (
                ...
                O("template", F, E, ba),
                (F = E),
                (v = C(E.template) ? E.template(ba, d) : E.template),
                (v = fa(v)),
                E.replace)
              ) {
                g = E;
        ...
        function Lf(a, b, c, e, f, g, h, l) {
          ...
          return function (a, b, c, d, e) {
            ...
            b.$$destroyed ||
              (k
                ? k.push(b, c, d, a)
                : (r.transcludeOnThisElement && (a = P(b, r.transclude, e)),
                  r(n, b, c, d, a, r)));
          };
        }
        function za(a, b) {
    ...
    this.$get = [
      ...
      function (b, a) {
        ...
        if (l) {
          ...
          !d ||
            (k && n) ||
            ((k = I(l.webkitTransition)), (n = I(l.webkitAnimation)));
        }
        return {
          ...
          compile: function (f, g) {
            ...
            return function (a, f, g, k, n) {
              ...
              a.$watchCollection(q, function (g) {
                ...
                for (k = 0; k < D; k++)
                  if (
                    ((F = g === L ? k : L[k]), (I = g[F]), (H = M[k]), H.scope)
                  ) {
                    w = u;
                    do w = w.nextSibling;
